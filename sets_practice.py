...
# In the random library, there's a function named sample that takes two arguments: an iterable to sample from, 
# and an integer of how many unique samples to return.
